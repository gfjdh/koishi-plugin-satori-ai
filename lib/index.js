...
((Sat2) => {
  Sat2.Config = import_koishi3.Schema.intersect([
    ...
    import_koishi3.Schema.object({
      ...
      log_reasoning_content: import_koishi3.Schema.boolean().default(true).description("是否在日志中输出思维链（deepseek-r1）")
    }).description("请求设置"),
    import_koishi3.Schema.object({
    ...
    import_koishi3.Schema.object({
      enable_favorability: import_koishi3.Schema.boolean().default(false).description("是否开启好感度系统"),
