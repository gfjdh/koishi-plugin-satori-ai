...
export declare function inputContentCheck(ctx: Context, content: string, userid: string, config: FavorabilityConfig, session: Session): Promise<number>;
export declare function outputContentCheck(ctx: Context, response: {
    content: string;
    error: boolean;
}, userid: string, config: FavorabilityConfig, session: Session): Promise<number>;
